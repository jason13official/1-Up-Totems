package com.cursee.one_up_totems.impl.common.util;
...
/**
 * <a href="https://github.com/Darkhax-Minecraft/Bookshelf/blob/1.21.1/common/src/main/java/net/darkhax/bookshelf/common/api/function/CachedSupplier.java">Adapted from Bookshelf</a>
...
public class CachedSupplier<T> implements Supplier<T> {
  ...
  public static <T> CachedSupplier<T> of(ResourceKey<T> key) {
    return CachedSupplier.cache(() -> {
      ...
      if (registry == null) {
        System.out.println("[OneUpTotems] Registry " + key.registry() + " could not be found!");
  ...
  public static <T> CachedSupplier<T> of(Registry<T> registry, String namespace, String path) {
    return of(registry, new ResourceLocation(namespace, path));
  }
